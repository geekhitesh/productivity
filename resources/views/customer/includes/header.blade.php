...
<meta name="keywords" content="Best Catering Services | Best Wedding Caterers In Delhi NCR |" />
		...
		<div class="container">
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					<h1><a href="index.php">Bartenders <span> </span></a></h1>
				</div>
				<div class="logo-nav-left1">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
									...
									<div class="row">
										<div class="col-sm-6">
											<ul class="multi-column-dropdown">
												...
												<li><a href="">Catering For Every Occasion</a></li>
												<li><a href="">Wedding Services</a></li>
												<li><a href="">Birthday Function</a></li>
												<li><a href="">Theme Parties</a></li>
												<li><a href="">Catering Services</a></li>
												<li><a href="">Venue Beautification</a></li>
										...
										<div class="col-sm-6">
											<ul class="multi-column-dropdown">												
												<li><a href="">Accommodation For Guests</a></li>
												<li><a href="">Crockery Arrangements</a></li>
												<li><a href="">Sending Invitations</a></li>
												<li><a href="">Corporate Events</a></li>
												<li><a href="">Jaimala Themes And Entertainment</a></li>
								...
								<ul class="dropdown-menu multi-column columns-3">
									<div class="row">
										<div class="col-sm-12">
											<ul class="multi-column-dropdown">
												<!-- <h6> Offer </h6> -->
												<li><a href="">Vegetarian Menu</a></li>
												<li><a href="">Silver Menu</a></li>
												<li><a href="">Silky Silver Menu</a></li>
												<li><a href="">Golden Menu</a></li>
												<li><a href="">Diamond Menu</a></li>
							...
							<li><a href="short-codes.php">Gallery</a></li>
